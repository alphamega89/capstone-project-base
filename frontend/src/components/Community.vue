<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Community # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Community
        </v-card-title >
        ...
        <v-card-text>
            ...
            <Photo offline label="Photo" v-model="value.photo"
                    :editMode="editMode" @change="change"/>
            <Address offline label="Address" v-model="value.address"
                    :editMode="editMode" @change="change"/>
            <div>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/communities'), this.value)
                        } else {
